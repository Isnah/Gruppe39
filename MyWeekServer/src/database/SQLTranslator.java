...
public class SQLTranslator {
	 ...
	 * deleteAppointmentOrMeeting() //1: holder med � slette bare m�tet/avtalen - databasen tar seg av resten
	 * 								//2: opprette CancelNotifications her
	 * updateMeetingAnswer()
	 * getNotificationsForPerson() //gjelder b�de cancelNotifications til gjeldende person og meetingAnswers
	 * 							   //til deltakere i m�ter som personen har laget (dersom de har declinet).
	 ...
	 * 
	 * *removeAttendeeFromMeeting(int mtnID, String email) - gj�res i UpdateAppointmentOrMeeting()
	 * *removeGroupFromMeeting(int mtnID, Group group) - gj�res i UpdateAppointmentOrMeeting()
	 */
